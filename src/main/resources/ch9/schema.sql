DROP SCHEMA IF EXISTS CH9;
CREATE SCHEMA CH9;

CREATE TABLE CH9.CONTACT (
...
CREATE TABLE CH9.HOBBY (
	HOBBY_ID VARCHAR(20) NOT NULL,
	PRIMARY KEY (HOBBY_ID)
);

CREATE TABLE CH9.CONTACT_TEL_DETAIL (
	ID INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE CH9.CONTACT_INTEREST (
	ID INT NOT NULL AUTO_INCREMENT,
	CONTACT_ID INT NOT NULL,
...
CREATE TABLE CH9.CONTACT_HOBBY_DETAIL (
	CONTACT_ID INT NOT NULL,
	HOBBY_ID VARCHAR(20) NOT NULL,
