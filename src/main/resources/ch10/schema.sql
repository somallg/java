DROP SCHEMA IF EXISTS CH10;
CREATE SCHEMA CH10;

CREATE TABLE CH10.CONTACT (
...
CREATE TABLE CH10.CONTACT_AUDIT (
	ID INT NOT NULL AUTO_INCREMENT,
	FIRST_NAME VARCHAR(60) NOT NULL,
	LAST_NAME VARCHAR(40) NOT NULL,
	BIRTH_DATE DATE,
...
CREATE TABLE CH10.CONTACT_AUDIT_H (
	ID INT NOT NULL,
	FIRST_NAME VARCHAR(60) NOT NULL,
	LAST_NAME VARCHAR(40) NOT NULL,
...
CREATE TABLE CH10.REVINFO (
	REVTSTMP BIGINT NOT NULL,
	REV INT NOT NULL AUTO_INCREMENT,
	PRIMARY KEY (REVTSTMP, REV)
);

CREATE TABLE CH10.HOBBY (
	HOBBY_ID VARCHAR(20) NOT NULL,
	PRIMARY KEY (HOBBY_ID)
);

CREATE TABLE CH10.CONTACT_TEL_DETAIL (
	ID INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE CH10.CONTACT_INTEREST (
	ID INT NOT NULL AUTO_INCREMENT,
	CONTACT_ID INT NOT NULL,
	INTEREST_TYPE VARCHAR(20) NOT NULL,
	INTEREST_NUMBER VARCHAR(20) NOT NULL,
	PRIMARY KEY (ID),
	CONSTRAINT FK_CONTACT_INTEREST_1 FOREIGN KEY (CONTACT_ID) REFERENCES CONTACT (ID)
);

CREATE TABLE CH10.CONTACT_HOBBY_DETAIL (
	CONTACT_ID INT NOT NULL,
	HOBBY_ID VARCHAR(20) NOT NULL,
